...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var APIService = function APIService(http) {
      ...
      this.getUsers = function () {
        return _this.http.get('https://jensjorisdecorte-backend-example-2.glitch.me/users');
      };

      this.getNotesForUser = function (userName) {
        return _this.http.get('https://jensjorisdecorte-backend-example-2.glitch.me/notes?name=' + userName);
      };

      this.AddUser = function (value) {
        return _this.http.post('https://jensjorisdecorte-backend-example-2.glitch.me/users', {
          name: value
        });
      };

      this.DeleteUser = function (name) {
        return _this.http["delete"]('https://jensjorisdecorte-backend-example-2.glitch.me/remove?name=' + name);
      };

      this.AddNote = function (name, contentValue) {
        return _this.http.post('https://jensjorisdecorte-backend-example-2.glitch.me/addnote?name=' + name, {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_11_Template_button_click_1_listener() {
          ...
          return ctx_r4.DeleteUser(user_r2.name);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_11_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
          ...
          return ctx_r6.GetNotes(user_r2.name);
        });
    ...
    function AppComponent_div_25_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_25_Template_button_click_8_listener() {
          ...
          return ctx_r10.EditNote(note_r7);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_25_Template_button_click_10_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
          ...
          return ctx_r12.DeleteNote(note_r7);
        });
    ...
    function () {
      function AppComponent(apiService) {
        ...
        this.notes = [];
        this.editNote = false;
        apiService.getUsers().subscribe(function (data) {
          console.log(data);
          _this2.usersList = data;
        });
        this.makeNote = false;
      }
      ...
      _createClass(AppComponent, [{
        ...
        value: function GetNotes(userName) {
          ...
          if (userName != "undefined") {
            this.apiService.getNotesForUser(userName).subscribe(function (data) {
              _this3.notes = data;
              console.log(_this3.notes);
              _this3.currentUser = userName;
            });
          } else {
        ...
        value: function DeleteNote(note) {
          ...
          console.log(note);
          this.apiService.DeleteNote(note.id).subscribe(function (response) {
            console.log(response);

            _this4.GetNotes(_this4.currentUser);
          });
        }
      }, {
        key: "EditNote",
        ...
        value: function AddUser(userName) {
          ...
          if (userName) {
            this.apiService.AddUser(this.newUser).subscribe(function (response) {
              console.log(response);
              _this5.messageAddUser = JSON.stringify(response);
              _this5.errorMessage = response.message;
              console.log(_this5.errorMessage);

              _this5.apiService.getUsers().subscribe(function (data) {
                _this5.usersList = data;
              });

              if (_this5.errorMessage) _this5.DisplayMessage(_this5.errorMessage);
              _this5.newUser = "";
              _this5.currentUser = _this5.newUser;

              _this5.GetNotes(userName);
            });
          } else {
            this.DisplayMessage("Geef een naam in");
          }
        ...
        key: "AddNote",
        value: function AddNote(currentUser, newNote) {
          var _this6 = this;

          if (newNote) {
            // SAVE NEW NOTE
            if (!this.editNote) {
              this.apiService.AddNote(this.currentUser, this.newNote).subscribe(function (response) {
                _this6.makeNote = true;
                console.log(response);
                _this6.newNote = "";
              });
            } else {
        ...
        value: function DeleteUser(userName) {
          ...
          if (userName) {
            this.apiService.DeleteUser(userName).subscribe(function (response) {
              _this7.user = response;
              console.log(_this7.user);

              _this7.apiService.getUsers().subscribe(function (data) {
                _this7.usersList = data;
              });

              console.log(response.success);
              if (response.success) _this7.DisplayMessage(response.success);else {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 34,
      vars: 5,
      consts: [["charset", "utf-8"], ["fxFlex", "", "fxLayout", "column", "fxLayoutGap", "10px", 2, "height", "100vh"], ["fxLayout", "row wrap"], ["fxFlex", "50", "fxLayout", "column", "fxFlex.lt-md", "70"], [4, "ngFor", "ngForOf"], [1, "inputbox"], ["matInput", "", "name", "first", 3, "ngModel", "ngModelChange"], ["mat-raised-button", "", 1, "aButton", 3, "click"], ["fxFlex", "30", "fxLayout", "column", "fxFlex.lt-md", "70"], ["appearance", "fill"], ["matInput", "", 3, "ngModel", "ngModelChange"], ["title", "delete user and notes", "mat-raised-button", "", 1, "delButton", 3, "click"], ["title", "Show notes for this user", "mat-button", "", 1, "userButton", 3, "click"], ["mat-button", "", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_18_listener() {
            return ctx.AddUser(ctx.newUser);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_textarea_ngModelChange_30_listener($event) {
            return ctx.newNote = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_32_listener() {
            return ctx.AddNote(ctx.currentUser, ctx.newNote);
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _src_app_material_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _src_app_app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _src_app_material_module__WEBPACK_IMPORTED_MODULE_5__["MaterialModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_8__["FlexLayoutModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_src_app_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _src_app_app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _src_app_material_module__WEBPACK_IMPORTED_MODULE_5__["MaterialModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_8__["FlexLayoutModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\J.Janssen1\OneDrive - Sanoma\Perso\Angular\NotesApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
